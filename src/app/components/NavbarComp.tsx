...
export default function NavbarComp() {
    ...
    return (
        <nav className={`p-2 relative px-4 flex justify-between place-items-center items-center bg-gray-200 w-[90%] h-[70px] justify-self-center ${!mobileOpened ? 'rounded-b-xl' : ''}`}>
            <Image src={'/images/ev-web-logo.webp'} className="w-[50px] h-[50px]" width={96} height={96} alt="EV-LOGO" />
            ...
            <Link href={'https://www.roblox.com/games/18377062010/ALPHA-Emergency-Valladolid'} target="_blank" className="hidden sm:block bg-gray-800 text-white p-1 px-4 rounded-md">Jugar EV</Link>
            ...
            <div className="hidden sm:hidden top-[65px] w-full left-0 bg-gray-200 z-10 rounded-b-xl" id="mobile-menu">
                <div className="px-2 pb-3 pt-2">
                    ...
                    <Link href={'https://www.roblox.com/games/18377062010/ALPHA-Emergency-Valladolid'} target="_blank" className="w-full mt-4 flex justify-center sm:block bg-gray-800 text-white p-1 px-4 rounded-md">Jugar EV</Link>
                </div>
            </div>
        </nav>
    )
